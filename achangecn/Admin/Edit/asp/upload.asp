...
Sub DoSave()
	...
	'response.write("<script language='javascript'>alert('rfewf');</script>")
End Sub
...
Sub DoUpload_Class()
	...
	'response.write("<script language='javascript'>alert('"&sSaveFileName&"');</script>")
	'response.write("<script language='javascript'>window.parent.form1.imgUrl.value='ddddss';</script>")
	Set oFile = Nothing
	Set oUpload = Nothing
End Sub
