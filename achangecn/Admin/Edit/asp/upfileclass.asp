...
<%
Dim oUpFileStream
Dim sObjectAdodbStream
sObjectAdodbStream = "ADOD" & "B.St" & "ream"
...
Class UpFile_Class
	...
	Public Sub GetData(MaxSize)
		...
		File.CompareMode = 1
		Set tStream = Server.CreateObject(sObjectAdodbStream)
		Set oUpFileStream = Server.CreateObject(sObjectAdodbStream)
...
Class FileInfo_Class
	...
	Public Function SaveToFile(Path)
		...
		Dim oFileStream
		Set oFileStream = CreateObject(sObjectAdodbStream)
		oFileStream.Type = 1
		oFileStream.Mode = 3
		oFileStream.Open
