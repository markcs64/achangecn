...
document.writeln('<iframe id=meizzDateLayer Author=wayx frameborder=0 scrolling=no width=142 height=230 style="position: absolute; z-index: 9998; display: none"></iframe>');
strFrame='<style>';
