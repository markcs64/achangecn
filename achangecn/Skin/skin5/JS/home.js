...
if(_self.hasLoggedIn()){dWel.innerHTML='<span class="default">Welcome, '+_self.getFirstName()+'</span> | <a href="../../../aliskin/images/'+config.signoutURL+'">Sign Out</a>'}else{dWel.innerHTML='<a href="javascript:signin()"  ><strong>Sign In</strong></a> | <a href="../../../aliskin/images/'+config.joinWithCD0URL+config.joinFrom+'"><strong>Join Now</strong></a>';}}
