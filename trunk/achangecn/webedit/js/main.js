...
config.StyleMenuHeader = "<head>"
	...
	+"<link href='" + sEditorRootPath + "/css/menuarea.css' type='text/css' rel='stylesheet'>"
	+"</head>"
...
config.StyleEditorHeader1 = "<head>"
	+"<link href='" + sEditorRootPath + "/language/" + AvailableLangs["Active"] + ".css' type='text/css' rel='stylesheet'>"
	+"<link href='" + sEditorRootPath + "/css/editorarea.css' type='text/css' rel='stylesheet'>";
...
document.write ("<link href='css/editor.css' type='text/css' rel='stylesheet'>");
