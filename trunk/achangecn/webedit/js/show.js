...
if (config.StateFlag=="1"){
	...
	document.write ("		<table border=0 cellpadding=0 cellspacing=0 height=20>");
	document.write ("		<tr>");
	document.write ("		<td><a href='http://www.4ngel.net' target='_blank' style='padding-right:30px;color:#000000; text-decoration:underline;'></a></td>");
...
document.write ("<div id='eWebEditor_Temp_HTML' style='VISIBILITY: hidden;z-index:200; OVERFLOW: hidden; POSITION: absolute; WIDTH: 1px; HEIGHT: 1px'></div>");
