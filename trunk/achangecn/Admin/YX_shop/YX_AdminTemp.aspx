<%@ page language="C#" autoeventwireup="true" inherits="Admin_YX_Shop_YX_AdminTemp, App_Web_hzrmr9fw" %>
	...
	<asp:DataGrid ID="dg1" AutoGenerateColumns="False" CellPadding="1" CellSpacing="1" PageSize="20"  runat="server"  Width="100%" AllowPaging="True" border=0 OnItemDataBound="dg1_ItemDataBound" > <HeaderStyle  CssClass="topbg" Height="25px"  HorizontalAlign="Center" />
               ...
               <asp:TemplateColumn HeaderText="选   择">
                <ItemTemplate >
				 ...
				 <input id="YX_CH" name="YX_CH" type="radio" style="border:0 " value="<%# DataBinder.Eval(Container.DataItem,"YX_ID") %>"  />
                </ItemTemplate>
                      <HeaderStyle CssClass="B" />
             </asp:TemplateColumn>
              <asp:TemplateColumn HeaderText="I  D">
                <ItemTemplate >
			<%# DataBinder.Eval(Container.DataItem,"YX_ID") %>                </ItemTemplate>
                      <HeaderStyle CssClass="B" />
             </asp:TemplateColumn>
			      <asp:TemplateColumn HeaderText="风格图片">
                <ItemTemplate >
		    <img alt="风格" src="../../<%# DataBinder.Eval(Container.DataItem,"YX_ShopTemppic") %>" width="100" height="120" />                </ItemTemplate>
                      <HeaderStyle CssClass="B" />
             </asp:TemplateColumn>
             <asp:TemplateColumn HeaderText="风格名称">
                <ItemTemplate >	
			<%# DataBinder.Eval(Container.DataItem,"YX_ShopTemplateName") %>				                </ItemTemplate>
                  <HeaderStyle CssClass="B" />
             </asp:TemplateColumn>
              <asp:TemplateColumn HeaderText="文件夹名称">
                <ItemTemplate >
			<%# DataBinder.Eval(Container.DataItem,"YX_CssName") %>                </ItemTemplate>
                  <HeaderStyle CssClass="B" />
             </asp:TemplateColumn>
            <asp:TemplateColumn HeaderText="默认风格">
                <ItemTemplate>
			<a href="?YX_FS=SZ&YX_MID=<%#Eval("YX_Id")%>"><%#SelRank(Convert.ToInt32(DataBinder.Eval(Container.DataItem, "YX_default")))%></a>                </ItemTemplate>
                  <HeaderStyle CssClass="B" />
             </asp:TemplateColumn>
             <asp:TemplateColumn HeaderText="操　　作">
				...
				<a href="?YX_FS=Del&YX_MID=<%#Eval("YX_ID") %>" onClick="return isdel()"><img src="../../Skin/skin5/IMAGES/no.gif" alt="删除" style="border:0" /></a>                </ItemTemplate>
                  <HeaderStyle CssClass="B" />
             </asp:TemplateColumn>			 
            </Columns>
            ...
            <tr bgcolor="#E7E7E7">
                <td align="center" bgcolor="#E7E7E7" style="width: 900px;color:#000000">
                   ...
                   <asp:HyperLink ID="start" runat="server" ForeColor="#000000">首　页</asp:HyperLink>
                    ...
                    <asp:DropDownList ID="iPage" runat="server" AutoPostBack="True" OnSelectedIndexChanged="sic">              </asp:DropDownList>    <asp:Button ID="Button1" runat="server" Text="选为默认模板" OnClick="Button1_Click" onmousemove=showBtnOver(this) onmouseout=showBtnOut(this)  CssClass="submitMiniGreen"/></td>
  ...
  <tr>
    ...
    <asp:TextBox ID="TextBox1" runat="server"></asp:TextBox>
        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="TextBox1"
            ErrorMessage="风格名称不能为空"></asp:RequiredFieldValidator></td>
  </tr>
            <tr>
              <td align="right" bgcolor="#F6F6F6" >
                  <asp:Label ID="Label3" runat="server" Text="原图地址：" Visible="False"></asp:Label></td>
              <td height="25" align="left" valign="middle" bgcolor="#F6F6F6" style="width: 189px">
                  &nbsp;<asp:TextBox ID="imgUrl" runat="server" Visible="False"></asp:TextBox> </td>
            </tr>
    <tr>
        <td align="right" bgcolor="#f6f6f6">
            缩微图地址：</td>
        <td align="left" bgcolor="#f6f6f6" height="25" style="width: 189px" valign="middle">
  ...
  <tr>
    ...
    <td>&nbsp;<asp:TextBox ID="TextBox2" runat="server"></asp:TextBox>
        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="TextBox2"
            ErrorMessage="文件夹名称不能为空"></asp:RequiredFieldValidator></td>
  </tr>
  <tr>
    <td align="right">风格说明</td>
    <td >&nbsp;<asp:TextBox ID="TextBox3" runat="server" Rows="10" TextMode="MultiLine" Width="200px"></asp:TextBox>
