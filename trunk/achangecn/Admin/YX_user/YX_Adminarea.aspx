<%@ page language="C#" autoeventwireup="true" inherits="Admin_YX_user_YX_Adminarea, App_Web_ezi-zx_s" %>
...
<tr><td></td><td>    
    ...
    <table  align="center" cellpadding="4" cellspacing="1" border="0" width=100%  class="toptable grid">
         ...
         <td class="category">
             <asp:HyperLink ID="HyperLink1" NavigateUrl="?YX_FS=Add" runat="server">[添加会员地区]</asp:HyperLink>
             <asp:HyperLink ID="HyperLink2" NavigateUrl="?YX_FS=JS" runat="server">[生成会员地区JS]</asp:HyperLink>
           </td>
        </tr>
 </table>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr>
    <td width="100%">
	<asp:DataGrid ID="dg1" AutoGenerateColumns="False" CellPadding="0" CellSpacing="0" PageSize="20"  runat="server"  Width="100%" AllowPaging="True" > <HeaderStyle  CssClass="topbg" Height="25px"  HorizontalAlign="Center" />
              ...
              <asp:TemplateColumn HeaderText="I  D">
				...
				<%# Eval("YX_ID") %>
                      ...
                      <HeaderStyle CssClass="B" />
             			      ...
             			      <asp:TemplateColumn HeaderText="地区名称">
                <ItemTemplate >
		        <%#Displaycsz(Convert.ToInt32(Eval("YX_ID")), Eval("YX_areaname").ToString())%>        
             ...
             <asp:TemplateColumn HeaderText="操　　作">
                <ItemTemplate >
				<a href="YX_Editarea.aspx?YX_FS=Edit&YX_MID=<%#Eval("YX_ID")%>"><img src="../../Skin/skin5/IMAGES/icon_edit.gif"  alt="修改" style="border:0" /></a>
          ...
          <table width="100%" border="0" align="center" cellpadding="1" cellspacing="1" id="TABLE1">
            ...
            <tr>
              ...
              <td height="25" align="left" bgcolor="#F6F6F6">
                <ChangHope:areaClass ID="Pc" runat="server" />  &nbsp;</td>
