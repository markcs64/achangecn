            ...
            <tr>
              ...
              <td height="25" align="left" bgcolor="#F6F6F6" style="width:700px">
                    ...
                    <asp:ListItem Value="Default">首页</asp:ListItem>
                             <asp:ListItem Value="Productlist_1">商品列表，带分页</asp:ListItem> 
                             <asp:ListItem Value="ShowProduct">商品详细显示页</asp:ListItem>
                             <asp:ListItem Value="Pinglun">商品评论</asp:ListItem>
                             <asp:ListItem Value="HighlevelSearch">商品高级搜索</asp:ListItem>
                             <asp:ListItem Value="Worth">帐户充值</asp:ListItem>
                             <asp:ListItem Value="show_buyproduct">求购商品</asp:ListItem>
                             <asp:ListItem Value="browse_offer">求购专区</asp:ListItem>
                             <asp:ListItem Value="buyproduct_comp">求购商品对比页面</asp:ListItem>
                           <%--  <asp:ListItem Value="HSearchResult">商品高级搜索结果</asp:ListItem>--%>
                            ...
                            <%-- <asp:ListItem Value="LiPin">礼品中心页面</asp:ListItem>--%>
                             <asp:ListItem Value="History_Pro">浏览过商品的列表（分页）</asp:ListItem>
                             <asp:ListItem Value="Product_Comp">商品对比页面</asp:ListItem>
                            ...
                            <%-- <asp:ListItem Value="Yx_Vote">留言页</asp:ListItem>--%>
                             ...
                             <asp:ListItem Value="ProClass_list">商品所有分类列表页</asp:ListItem>
                             <asp:ListItem Value="History_Pro">最近商品浏览列表页</asp:ListItem> 
                             <asp:ListItem Value="Basket">商品订购页面</asp:ListItem>
                             <asp:ListItem Value="BasketNext">商品订购下一步页面</asp:ListItem>
                             <asp:ListItem Value="Basket_cj">商品出价页面</asp:ListItem>
                             <asp:ListItem Value="Basket_cjNext">商品出价下一步页面</asp:ListItem>
                             <asp:ListItem Value="Pay_state_info">商品付款页面</asp:ListItem>
                             <asp:ListItem Value="Pay_state_info_next">商品付款下一步页面</asp:ListItem>
                           ...
                           <%--   <asp:ListItem Value="QueHuo">缺货登记页面</asp:ListItem>--%>
                             ...
                             <asp:ListItem Value="VipReg">会员注册页面</asp:ListItem>
                              ...
                              <%-- <asp:ListItem Value="Yx_VipCollection">会员商品收藏页面</asp:ListItem>--%>
                              ...
                              <%--   <asp:ListItem Value="YX_VipJF">会员中心积分页面</asp:ListItem>--%>
                               <%-- <asp:ListItem Value="Yx_ModiPass">会员中心修改密码页面</asp:ListItem>--%>
                                <asp:ListItem Value="Yx_ShopIndex">商铺首页</asp:ListItem>
                                 <asp:ListItem Value="showshop">浏览商铺</asp:ListItem>
                                  <asp:ListItem Value="infouser">个人资料页面</asp:ListItem>
                                   <asp:ListItem Value="Erro">错误页面</asp:ListItem>
                                    <asp:ListItem Value="YX_ProVotere">商品留言回复页面</asp:ListItem>
                                    <asp:ListItem Value="YX_ShopVotere">店铺留言回复页面</asp:ListItem>
<asp:ListItem Value="YX_Hotsell">热卖商品</asp:ListItem>
                             </asp:DropDownList>
