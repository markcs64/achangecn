...
document.write('<script type="text/javascript" src="'+urlPrefix+'locale/'+TB.env.lang.toLowerCase()+'.js"><\/script>');document.write('<link type="text/css" rel="stylesheet" href="'+urlPrefix+'assets/tbra.css" />');}
TB.init();
