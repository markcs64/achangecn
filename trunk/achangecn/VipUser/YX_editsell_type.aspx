...
<table class=main border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <asp:TextBox ID="sTitle" runat="server" name="sTitle" dataType="Require" min="3" max="10"  msg="请填写物品名称" type="text" maxlength="60" size="60" ></asp:TextBox>
    </td>
  ...
  <tr>
    ...
    <script type="text/javascript" src="Edit/editor.js" charset="gb2312"></script>
        <asp:TextBox ID="content" runat="server" cols=70  Width='100%' rows=15 dataType="LimitB" min="3" max="500000"  msg="物品详细描述必须在[3～50000]个字符之内,一个中文是两个字符!" name="content"  TextMode="MultiLine" ></asp:TextBox>
     ...
     <tr>
        ...
        <td class="td_03">
         ...
         <asp:RadioButtonList ID="cSendType" runat="server" RepeatDirection="Vertical">
            ...
            <asp:ListItem Text="见物品详情描述" Value="3"></asp:ListItem>
         </asp:RadioButtonList>
</td>
	 </tr>
     <tr>
      ...
      <tr>
        ...
        <asp:TextBox ID="dwOpNum" require = "true" datatype="Number" msg="物品数量必须是数字" runat="server"></asp:TextBox>
    件<span id="buyerLimitErr" style="color:red"></span>&nbsp;&nbsp;&nbsp;&nbsp;同一买家购买该物品的数量上限（0件表示不限制）
		</td>
      </tr>
       </asp:Panel>
