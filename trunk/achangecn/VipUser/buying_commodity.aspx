<%@ page language="C#" autoeventwireup="true" inherits="VipUser_buying_commodity, App_Web_xyjt5bop" %>
...
<TD vAlign=top>
      ...
      <asp:DataGrid ID="dg1"  BorderStyle="dashed"  runat="server" CellPadding="0" CellSpacing="0"  Width="100%"  AutoGenerateColumns="false">
              ...
              <asp:TemplateColumn HeaderText="卖家">
               ...
               <asp:TemplateColumn HeaderText="当前出价">
                <ItemTemplate >
             ...
             <ItemTemplate>
              <%#sj(Eval("YX_addtime"),Convert.ToInt32(Eval("YX_Proyxq")))%>天
             </ItemTemplate>
              <HeaderStyle CssClass="F"  />
              </asp:TemplateColumn>
              <asp:TemplateColumn HeaderText="出价状态">
             <ItemTemplate>
             <%#YX_OrderStart(Convert.ToInt32(Eval("YX_proid")),Convert.ToDouble(Eval("YX_reusercj")),1)%>
             </ItemTemplate>
                 <HeaderStyle CssClass="F"  />
              </asp:TemplateColumn> 
            </Columns>
