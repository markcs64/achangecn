<%@ page language="C#" validaterequest="false" inherits="CompanyReg, App_Web_e2dz2mbn" %>
...
<script language="javascript" src="http://www.achange.cn/Include/area.js"></script>
<form id="form1" runat="server">

<div id="RegInfo">
<ul>

<li>会员名称：<asp:textbox id="TextBox1" runat="server"></asp:textbox></li>
<li>帐户密码：<asp:textbox id="TextBox3" runat="server" TextMode="Password"></asp:textbox></li>
<li>重复密码：<asp:textbox id="TextBox2" runat="server" TextMode="Password"></asp:textbox></li>
<li>电子邮箱：<asp:textbox id="TextBox4" runat="server"></asp:textbox></li>
<li>易物经人：<asp:dropdownlist id="DropDownList1" runat="server"></asp:dropdownlist></li>

<%--
<li>经纪公司：<asp:dropdownlist id="DropDownList3" runat="server"></asp:dropdownlist></li>
<li>联系人：<asp:textbox id="TextBox5" runat="server"></asp:textbox></li>
<li>企业名称：<asp:textbox id="TextBox6" runat="server"></asp:textbox></li>
<li>企业性质：<asp:textbox id="TextBox7" runat="server"></asp:textbox></li>
<li>联系电话：<asp:textbox id="TextBox8" runat="server"></asp:textbox></li>
<li>公司简介：<asp:textbox id="TextBox9" runat="server" height="233px" width="444px"></asp:textbox></li>
--%>
<li><asp:checkbox id="CheckBox1" runat="server" Text="填写详细资料"></asp:checkbox></li>
<li><asp:linkbutton id="LinkButton1" runat="server" OnClick="LinkButton1_Click">点此阅读红桥企业易物网会员注册服务条款</asp:linkbutton></li>
<li><asp:button id="Button1" runat="server" text="同意以上条款并注册" OnClick="Button1_Click" /></li>
</ul>
</div>
...
<div style="height:30px; width:760px; "></div>
<!-- 底部 定义-->
<DIV id="footer">
<table 
